...
namespace spacebattle.Tests
{
    ...
    public partial class ДвижениеКосмическогоКорабляFeature : object, Xunit.IClassFixture<ДвижениеКосмическогоКорабляFeature.FixtureData>, System.IDisposable
    {
...
#line hidden
        ...
        public ДвижениеКосмическогоКорабляFeature(ДвижениеКосмическогоКорабляFeature.FixtureData fixtureData, spacebattle_Tests_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru"), "", "Движение космического корабля", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                ДвижениеКосмическогоКорабляFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                ДвижениеКосмическогоКорабляFeature.FeatureTearDown();
            }
        }
    }
}
